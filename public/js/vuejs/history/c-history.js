...
/***/ "./resources/js/vuejs/history/c-history.js":
/*!*************************************************!*\
  !*** ./resources/js/vuejs/history/c-history.js ***!
  \*************************************************/
/*! no exports provided */
...
/* harmony import */ var _s_history__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./s-history */ "./resources/js/vuejs/history/s-history.js");
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this = _this2;
                _context.next = 3;
                return _s_history__WEBPACK_IMPORTED_MODULE_1__["default"].getHistories();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return _s_history__WEBPACK_IMPORTED_MODULE_1__["default"].create(_this.model);
              ...
              case 9:
                //update
                item = _this.listHistory[_this.getIndex];

                _this.initModel();

                _context2.next = 13;
                return _s_history__WEBPACK_IMPORTED_MODULE_1__["default"].update(_this.model, item.id);
              ...
              case 13:
                ...
                if (_response.success == true) {
                  _this.listHistory[_this.getIndex] = _response.data;
                  _this.state = 0;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this = _this4;
                id = _this.listHistory[_this.getIndex].id;
                _context3.next = 4;
                return _s_history__WEBPACK_IMPORTED_MODULE_1__["default"].destroy(id);
    ...
    openModal: function openModal(state, index) {
      ...
      if (state === 2) {
        ...
        var item = _this.listHistory[index];
...
/***/ "./resources/js/vuejs/history/s-history.js":
/*!*************************************************!*\
  !*** ./resources/js/vuejs/history/s-history.js ***!
  \*************************************************/
/*! exports provided: default */
...
var url = _config__WEBPACK_IMPORTED_MODULE_2__["default"].adminURL + "histories";

var getHistories = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", responese.data);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            uri = url + "/" + id;
            _context3.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(uri, body);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            uri = url + "/" + id;
            _context4.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"](uri);
...
/***/ 5:
/*!*******************************************************!*\
  !*** multi ./resources/js/vuejs/history/c-history.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\WORK\laravel\year4\Semantic Search\SemanticSearch\resources\js\vuejs\history\c-history.js */"./resources/js/vuejs/history/c-history.js");
